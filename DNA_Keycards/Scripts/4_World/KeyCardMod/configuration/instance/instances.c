class DNA_Keycards_System
{
	
	protected static ref DNA_Keycards_System Instance;
	
	protected static ref KeyCard_Config_System m_KeyCard_System_Config;
	
	void DNA_Keycards_System()
	{
		if(GetGame().IsServer())
	...
	static DNA_Keycards_System GetInstance()
	{
		if(!Instance)
			Instance = new DNA_Keycards_System();
		return Instance;
	}
