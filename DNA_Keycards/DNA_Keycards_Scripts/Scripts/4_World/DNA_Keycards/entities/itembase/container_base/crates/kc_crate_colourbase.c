...
{    
	...
	protected ref array<ref KCM_Config_Crate_System> kcm_CrateSystemConfig;
	...
	{
		kcm_CrateSystemConfig = DNA_Keycards_Crate_System.GetInstance().GetConfig().GetConfigData().GetSystemArray();
	...
	{
		if(kcm_CrateSystemConfig && action)
		{
			switch(action)
			{
				case "insert":
					return kcm_CrateSystemConfig.Get(86).GetSystemSetting() != 0;
			}
		}
		return false;
	}*/
	...
	{
		if(kcm_CrateSystemConfig && color)
		{
			switch(color)
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(0).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(15).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(30).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(45).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(60).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnMainMagsExtra(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(1).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(16).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(31).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(46).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(61).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnMainAttachments(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(2).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(17).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(32).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(47).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(62).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnMainAmmoExtra(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(3).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(18).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(33).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(48).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(63).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnSideArm(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(4).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(19).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(34).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(49).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(64).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnSideMagsExtra(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(5).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(20).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(35).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(50).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(65).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnSideAttachments(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(6).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(21).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(36).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(51).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(66).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnSideAmmoExtra(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(7).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(22).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(37).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(52).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(67).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnFood(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(8).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(23).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(38).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(53).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(68).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnDrink(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(9).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(24).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(39).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(54).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(69).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnTools(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(10).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(25).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(40).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(55).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(70).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnBuildMats(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(11).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(26).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(41).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(56).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(71).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnValuables(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(12).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(27).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(42).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(57).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(72).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnClothes(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(13).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(28).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(43).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(58).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(73).GetSystemSetting() != 0;
			}
		}
		return false;
	}
	...
	bool CanSpawnMeds(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(14).GetSystemSetting() != 0;
				case "green":
					return kcm_CrateSystemConfig.Get(29).GetSystemSetting() != 0;
				case "blue":
					return kcm_CrateSystemConfig.Get(44).GetSystemSetting() != 0;
				case "purple":
					return kcm_CrateSystemConfig.Get(59).GetSystemSetting() != 0;
				case "red":
					return kcm_CrateSystemConfig.Get(74).GetSystemSetting() != 0;
			}
		}
		return false;
	...
	int ValuableSpawnChance(string color)
	{
		if(kcm_CrateSystemConfig && color)
		{
			...
			{
				case "yellow":
					return kcm_CrateSystemConfig.Get(10).GetSystemSetting();
				case "green":
					return kcm_CrateSystemConfig.Get(25).GetSystemSetting();
				case "blue":
					return kcm_CrateSystemConfig.Get(40).GetSystemSetting();
				case "purple":
					return kcm_CrateSystemConfig.Get(55).GetSystemSetting();
				case "red":
					return kcm_CrateSystemConfig.Get(70).GetSystemSetting();
			}
		}
		return 0;
	}	
