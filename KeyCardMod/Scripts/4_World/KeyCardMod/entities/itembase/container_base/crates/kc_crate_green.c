class KC_Crate_Green: KC_Crate_ColourBase
{
	...
	void KC_Crate_Green()
	{
		kcm_Loadouts = KeyCardMod_Green.GetInstance().GetConfig().GetConfigData().GetWeaponsArray();
		kcm_Outfits = KeyCardMod_Green.GetInstance().GetConfig().GetConfigData().GetClothingArray();
		kcm_WeaponVars = KeyCardMod_Green.GetInstance().GetConfig().GetConfigData().GetWeaponVarsArray();
	}
