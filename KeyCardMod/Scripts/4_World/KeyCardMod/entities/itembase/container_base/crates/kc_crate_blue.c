class KC_Crate_Blue: KC_Crate_ColourBase
{
	...
	void KC_Crate_Blue()
	{
		kcm_Loadouts = KeyCardMod_Blue.GetInstance().GetConfig().GetConfigData().GetWeaponsArray();
		kcm_Outfits = KeyCardMod_Blue.GetInstance().GetConfig().GetConfigData().GetClothingArray();
		kcm_WeaponVars = KeyCardMod_Blue.GetInstance().GetConfig().GetConfigData().GetWeaponVarsArray();
	}
