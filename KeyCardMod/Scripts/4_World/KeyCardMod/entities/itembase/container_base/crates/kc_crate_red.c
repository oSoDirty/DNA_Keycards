...
{	
	...
	void KC_Crate_Red()
	{
		kcm_Loadouts = KeyCardMod_Red.GetInstance().GetConfig().GetConfigData().GetWeaponsArray();
		kcm_Outfits = KeyCardMod_Red.GetInstance().GetConfig().GetConfigData().GetClothingArray();
		kcm_WeaponVars = KeyCardMod_Red.GetInstance().GetConfig().GetConfigData().GetWeaponVarsArray();
	}
