class KC_Crate_Yellow: KC_Crate_ColourBase
{
	...
	{
		kcm_Loadouts = KeyCardMod_Yellow.GetInstance().GetConfig().GetConfigData().GetWeaponsArray();
		kcm_Outfits = KeyCardMod_Yellow.GetInstance().GetConfig().GetConfigData().GetClothingArray();
		kcm_WeaponVars = KeyCardMod_Yellow.GetInstance().GetConfig().GetConfigData().GetWeaponVarsArray();
	}
