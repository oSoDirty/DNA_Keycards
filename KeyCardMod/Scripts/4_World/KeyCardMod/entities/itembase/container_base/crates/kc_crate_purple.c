class KC_Crate_Purple: KC_Crate_ColourBase
{
	...
	{
		kcm_Loadouts = KeyCardMod_Purple.GetInstance().GetConfig().GetConfigData().GetWeaponsArray();
		kcm_Outfits = KeyCardMod_Purple.GetInstance().GetConfig().GetConfigData().GetClothingArray();
		kcm_WeaponVars = KeyCardMod_Purple.GetInstance().GetConfig().GetConfigData().GetWeaponVarsArray();
	}
