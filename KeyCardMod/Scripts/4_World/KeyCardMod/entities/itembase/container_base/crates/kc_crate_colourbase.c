...
{    
	...
	void KC_Crate_ColourBase()
	{
		...
		kcm_SideArms = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetSideArmArray();
		kcm_FoodItems = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetFoodArray();
		kcm_DrinkItems = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetDrinkArray();
		kcm_ToolItems = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetToolsArray();
		kcm_BuildingItems = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetBuildingArray();
		kcm_MedicalItems = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetMedicalArray();
		kcm_Valuables = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetValuablesArray();
		kcm_BaseConfig = KeyCardMod_Base.GetInstance().GetConfig().GetConfigData().GetBaseVarsArray();
	...
	{
		super.SetActions();
		AddAction(ActionOpenKCCrate);
		AddAction(ActionCloseKCCrate);
	}
	...
	void DoTheDamnThing(string color)
	{
		...
		Print("KeyCardMod: - A " + color + " tier crate has spawned loot at: " + GetPosition().ToString());
	}
};