...
{	
	...
	{
		if (!FileExist(kcm_ProfilePath + m_ConfigFolderName + "/"))
        {
			Print("[KCM_Debug] - KeyCardMod Config: Main directory not found, creating directory!");
			MakeDirectory(kcm_ProfilePath + m_ConfigFolderName + "/");
		}
	}
	...
	protected static void LoadConfig()
	{
		...
		if (!FileExist(kcm_ProfilePath + m_ConfigFolderName + "/System/"))
        {
			Print("[KCM_Debug] - KeyCardMod System: Directory not found, creating directory!");
			MakeDirectory(kcm_ProfilePath + m_ConfigFolderName + "/System/");
		}
		
		m_KeyCard_System_ConfigData = new KeyCard_ConfigData_System();
		
		if (!FileExist(kcm_ProfilePath + m_ConfigFolderName + "/System/" + m_ConfigName + "System" + m_ConfigExtension))
        {
			Print("[KCM_Debug] - KeyCardMod System: Config not found, creating default config!");
            CreateDefaultConfig();
        }
		else
		{
			JsonFileLoader<KeyCard_ConfigData_System>.JsonLoadFile(kcm_ProfilePath + m_ConfigFolderName + "/System/" + m_ConfigName + "System" + m_ConfigExtension, m_KeyCard_System_ConfigData);
		}
	}
	...
	{	
		...
		JsonFileLoader<KeyCard_ConfigData_System>.JsonSaveFile(kcm_ProfilePath + m_ConfigFolderName + "/System/" + m_ConfigName + "System" + m_ConfigExtension, m_KeyCard_System_ConfigData);
	}
}