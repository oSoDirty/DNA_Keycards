modded class MissionServer
{
	...
	void MissionServer()
	{
		...
		KeyCardMod_System.ClearInstance();
		KeyCardMod_Base.ClearInstance();
		KeyCardMod_Yellow.ClearInstance();
		KeyCardMod_Green.ClearInstance();
		KeyCardMod_Blue.ClearInstance();
		KeyCardMod_Purple.ClearInstance();
		KeyCardMod_Red.ClearInstance();
		
		KeyCardMod_System.GetInstance();
		KeyCardMod_Base.GetInstance();
		KeyCardMod_Yellow.GetInstance();
		KeyCardMod_Green.GetInstance();
		KeyCardMod_Blue.GetInstance();
		KeyCardMod_Purple.GetInstance();
		KeyCardMod_Red.GetInstance();
		
		kcm_SystemConfig = KeyCardMod_System.GetInstance().GetConfig().GetConfigData().GetSystemArray();
		kcm_YellowLocations = KeyCardMod_System.GetInstance().GetConfig().GetConfigData().GetLocationsYArray();
		kcm_GreenLocations = KeyCardMod_System.GetInstance().GetConfig().GetConfigData().GetLocationsGArray();
		kcm_BlueLocations = KeyCardMod_System.GetInstance().GetConfig().GetConfigData().GetLocationsBArray();
		kcm_PurpleLocations = KeyCardMod_System.GetInstance().GetConfig().GetConfigData().GetLocationsPArray();
		kcm_RedLocations = KeyCardMod_System.GetInstance().GetConfig().GetConfigData().GetLocationsRArray();
