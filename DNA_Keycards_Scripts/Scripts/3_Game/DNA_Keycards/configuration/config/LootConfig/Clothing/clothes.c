class KeyCard_Config_Clothing
{
	...
	static void CreateDefaultConfig()   //("tier", "helmet", "shirt", "vest", "pants", "shoes", "backpack", "gloves", "belt", "face", "eyes", "armband", "nvg")
	{
		...
		m_KeyCard_Clothing_ConfigData.GetClothingArray().Insert(new DNA_Config_Clothing("red", "Mich2001Helmet", "GorkaEJacket_Autumn", "HighCapacityVest_Olive", "GorkaPants_Autumn", "JumgleBoots_Green", "AliceBag_Green", "TacticalGloves_Green", "MilitaryBelt", "GP5GasMask", "GasMask_Filter", "", "NVGoggles"));
		m_KeyCard_Clothing_ConfigData.GetClothingArray().Insert(new DNA_Config_Clothing("red", "Mich2001Helmet", "M65Jacket_Black", "HighCapacityVest_Black", "GorkaPants_Autumn", "JumgleBoots_Black", "AliceBag_Black", "TacticalGloves_Black", "MilitaryBelt", "GP5GasMask", "GasMask_Filter", "", "NVGoggles"));
